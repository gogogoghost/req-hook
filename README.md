...
```html
<script src="https://cdn.jsdelivr.net/npm/req-hook@1.0.2/dist/req-hook.iife.js"></script>
<script>
  reqHook.init();
...
// @require      https://cdn.jsdelivr.net/npm/req-hook@1.0.2/dist/req-hook.iife.js
